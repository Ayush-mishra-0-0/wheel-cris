...
Paths are env-overridable (WHEEL_ML_ROOT) so the module can be consumed from
any checkout/container without hard-coded parents[] math.
"""
...
ML_ROOT = Path(os.environ.get("WHEEL_ML_ROOT", str(_REPO_ROOT / "ml"))).resolve()
